...
def write_input(traits, file_prefix):
    ...
    for i in range(len(traits)):
        with open((file_prefix + str(i) + ".txt"), 'w') as inputfile:
            ...
            inputfile.write("(sp2:5.493,(sp3:4.493,sp4:4.493):1.0);\n")
            inputfile.write("(sp3:5.493,(sp2:4.493,sp4:4.493):1.0);\n")
            inputfile.write("(sp4:5.493,(sp2:4.493,sp3:4.493):1.0);\n")
            inputfile.write("end;\n")
            inputfile.write("\n")
            inputfile.write("begin genetreefreqs;\n")
            inputfile.write("0.9784\n")
